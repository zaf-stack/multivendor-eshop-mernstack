...
const Singup = () => {
  ...
  return (
    ...
    // </div>
    <>
      <section className="bg-gradient-to-l from-[#e86a39] to-[#faf3ea]  min-h-screen flex items-center justify-center">
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-4xl  p-3 items-center">
          <div className="md:w-1/2 px-8 md:px-16">
            ...
            <p className="text-xs mt-4 text-[#002D74]">
              If you don't have an account, easily you can create
            </p>
